...
def parse_args():
    ...
    parser.add_argument('--model_lr_base',       type=float, default=0.001,       help='learning rate (default: 0.001)')
    parser.add_argument('--model_lr_range',      type=float, default=5.0,         help='learning rate range (default: 5.0)')
    parser.add_argument('--model_kl_target',     type=float, default=0.01,        help='learning rate (default: 0.01)')
