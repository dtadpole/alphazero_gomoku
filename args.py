...
def parse_args():
    ...
    parser.add_argument('--model_arch',          type=str,   default='conv',      help='model arch (conv, conv_bn, resnet)')
    ...
    parser.add_argument('--model_coef_entropy',  type=float, default=0.2,         help='coeffiency for entropy (default 0.2)')
    ...
    parser.add_argument('--model_epochs',        type=int,   default=5,           help='number of epoch to train (default: 5)')
    parser.add_argument('--model_lr_base',       type=float, default=0.002,       help='learning rate (default: 0.002)')
    parser.add_argument('--model_lr_range',      type=float, default=10.0,        help='learning rate range (default: 10.0)')
    ...
    parser.add_argument('--mcts_cpuct',          type=float, default=8.0,         help='mcts bound param (default: 8.0)')
    ...
    parser.add_argument('--train_game_count',    type=int,   default=4,           help='training game count (default: 4)')
